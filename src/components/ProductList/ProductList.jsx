...
export default function ProductList() {
  ...
  const [searchGroup, setSearchGroup] = useState('title');
    ...
    if (searchInput == '') {
      ...
      else if (searchGroup == 'title' && val.title.toLowerCase().includes(searchInput.toLowerCase())) {
        return val;
      } 
      else if (searchGroup == 'description' && val.description.toLowerCase().includes(searchInput.toLowerCase())) {
        return val;
      } 
      else if (searchGroup == 'category' && val.category.toLowerCase().includes(searchInput.toLowerCase())) {
        return val;
      } 
